...
# -----------------------------------
#PS1_OLD = '\h:\W \u$ '
PS1='\n@\h: \[\033[0;36m\]\w/ \[\033[1;95m\]$(__git_ps1 "(%s)")  \n\[\033[0;32m\]\u \[\033[0;33m\]->\[\033[00m\] '
# On some systems/shells/devices you might want to change the 36m (cyan) color option to 34m (blue) for better readability
